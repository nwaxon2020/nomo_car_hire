    ...
    <div className="space-y-10 animate-in fade-in duration-500">
      ...
      <section className={`p-6 rounded-2xl border-2 transition-all duration-500 ${
        ...
        <button 
          ...
          className={`mt-8 w-full md:w-auto px-10 py-3 rounded-xl font-black uppercase italic flex items-center justify-center gap-2 transition-all ${
            isDirty 
                    ...
                    <td className="px-6 py-6">
                      <div className="flex items-center gap-3">
                        ...
                        <button 
                          ...
                          title="Delete Customer from list (Reset Progress)"
                        >
                          <FiTrash2 size={18} />
                        </button>

                        <button 
                          onClick={() => window.open(`/user/${customer.id}`, '_blank')}
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl border border-gray-100 animate-in zoom-in duration-300">
            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mb-6 shadow-lg ${
               showConfirmModal.type === 'payment' ? 'bg-blue-100 text-blue-600' : 'bg-red-100 text-red-600'
            }`}>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button 
                ...
                className={`py-4 rounded-2xl text-white text-xs font-black uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2 ${
                  showConfirmModal.type === 'payment' 
