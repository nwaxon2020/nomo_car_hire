...
interface WaitingFormatProps {
    name: string;
    icon: ReactNode;
}

const WaitingFormat = ({ name, icon }: WaitingFormatProps) => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] p-6 text-center">
            ...
            >
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto leading-relaxed">
                    We are building a seamless way for you to book and manage {name.toLowerCase()} logistics. This feature will be available very soon!
                </p>
